...
root_img = '/dataset/AOLP/Subset_RP/Subset_RP/Subset_RP/Image'
root_anno = '/dataset/AOLP/Subset_RP/Subset_RP/Subset_RP/groundtruth_localization'
target_anno = '/data/AOLP/AOLP_RP/Annotations'
...
def gen_car_and_carplate_independently(dic):
    ...
    folder.appendChild(doc.createTextNode('AOLP_RP'))
    # filename
    ...
    database_.appendChild(doc.createTextNode('The AOLP Road Patrol'))
