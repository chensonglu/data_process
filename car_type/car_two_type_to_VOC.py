...
target_dir = '/data/VALID/1080p/car_two_type/VOC/Annotations'
...
car = ['家用轿车', '家用SUV', '家用MPV', '家用房车', '家用JEEP', '出租车', '面包车', '赛车', '救护车', '邮政车', '警车',
       '教练车', '四轮车']
bus_van_truck_etc = ['公共汽车', '小型客车', '大型客车', '校车', '油罐车', '垃圾车', '货运卡车', '小型货运卡车',
                     '消防车', '皮卡', '搅拌车', '三轮车', '箱式货车']

merged_type = {}
merged_type['car'] = car
merged_type['bus_van_truck_etc'] = bus_van_truck_etc
