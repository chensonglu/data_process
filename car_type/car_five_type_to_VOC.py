# 将车分成5种,参考KITTI和Apollo Scape
# car, bus, van, truck, tricycle
import os
...
target_dir = '/data/VALID/car_merged_type/VOC/Annotations'
...
truck = ['油罐车', '垃圾车', '货运卡车', '小型货运卡车', '消防车', '皮卡', '搅拌车']
van = ['箱式货车']
tricycle = ['三轮车']
