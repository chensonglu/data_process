#-*- coding: UTF-8 -*-
# 生成从粗到精端到端检测车牌的数据，从珠海标注的格式转换为VOC的xml格式
...
target_dir = r'C:\Users\chens\Desktop\20171214_20180203\720p\car_carplate_two_stage_e2e'
...
for fileitem in file_list:
    ...
    if fileitem.endswith('xml'):
        gen_car_carplate_two_stage_end2end(fileitem)
